...
save_path = 'Drone_anomaly_results/Railway Inspection/'
...
def test_all_scenes(model, test_path,seg_path, config, device=None):
    ...
    path_labels = '../Drone_Anomaly/Railway Inspection/label'
    list_np_labels = []
...
def main():
    ...
    if bool(config.train):
        ...
        train_folder = "../Drone_Anomaly/Railway Inspection/train/frames/"
        seg_folder = "../Drone_Anomaly_seg/Railway Inspection/train/frames/"
        ...
        test_folder = "../Drone_Anomaly_order/Railway Inspection/test/frames/"
        seg_test_folder = "../Drone_Anomaly_seg/Railway Inspection/test/frames/"
        ...
        for epoch in range(1, epochs + 1):
            ...
            if epoch >= 1:
                ...
                test_folder = "../Drone_Anomaly/Railway Inspection/test/frames"
                seg_folder  = "../Drone_Anomaly_seg/Railway Inspection/test/frames"
